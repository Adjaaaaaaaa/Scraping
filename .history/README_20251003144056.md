...
- Supprime les livres absents et enregistre les changements dans `book_history`
...
- Les chaînes (`category`, `availability`) sont **normalisées** pour éviter les problèmes de casse et d’espaces  
- `rating` = 1 à 5  
- `skip` ≥ 0, `limit` entre 1 et 500  
- Historique des modifications conservé dans `book_history`  
...
- Site de scraping : [Books to Scrape](http://books.toscrape.com/)  
- Réalisé dans le cadre de la formation **Développeur IA chez Simplon**
